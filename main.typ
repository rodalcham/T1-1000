...
From here, the user would then see an indicator that an error has been logged in the messages tab, and after pressing, they would be faced with all messages, wether they indicate success and therefore dont require any further attention, or they indicate an error, and require remediation. The following figure depicts somthing along this lines. 
#figure(
